...
<div class="page-container">
    ...
    <div class="main-content">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-6 clearfix">
                    <div class="user-profile pull-right">
                        ...
                        <h4 class="user-name dropdown-toggle" data-toggle="dropdown">Test User <i
        ...
        <div class="row" id="top-of-site">
            <div class="col-md-9"><p style="color:white;text-align:center;letter-spacing: 2.5px;">All Exams</p></div>
            <div class="col-md-3">
        ...
        <div id="reg-form" class="course-registration-form">
            ...
            <h4 style="padding-left: 8%; padding-top:2%;font-family:Arial;font-weight:600 !important;">Add New Exam</h4>
            ...
            @endif
            <form class="add-form" method="post" action="{{ route('exams.store') }}" enctype='multipart/form-data'>
                @csrf
                ...
                <input type="hidden" name="examcode" class="form-control" id="hidencoursecode"
                       value="Exm:{{ $newunionid }}">
                <input type="hidden" name="coursename" class="form-control" id="coursename">
                <input type="hidden" name="coursetestname" class="form-control" id="coursetestname">
                <div class="form-group">
                    <label for="exampleFormControlInput1">Exam Name</label>
                    <input type="text" name="Exam_title" class="form-control" id="exampleFormControlInput1"
                           placeholder="Enter the name">
                </div>

                <div class="form-group">
                    <label for="exampleFormControlInput1">Time Duration</label>
                    <input type="number" name="Exam_time" class="form-control" id="exampleFormControlInput1"
                ...
                <div class="form-group">
                    ...
                    <select class="form-control testcoursedropdown" name="coursetestid" class="form-control">
        ...
        <div class="details">
            ...
            <table id="modetab" class="table table-bordered">
                ...
                <tr>
                    ...
                    <th>Exam Code</th>
                    <th width="226px">Exam Icon</th>
                    <th width="106px">Exam Title</th>
                    <th width="202px">Exam Description</th>
                    <th>Course name</th>
                    <th>Course Testame</th>
                ...
                <tr class="data-row">
                    <td style="display:none;" class="align-middle basiccourseid">{{ $exam->id }}</td>
                    <td class="align-middle examcode">{{ $exam->examcode }}</td>
                    <td class="align-middle examIcon"><img width="75"
                                                           src="{{  URL::to('/') }}/images/{{ $exam->icon }}"/></td>
                    <td class="align-middle examtitle">{{ $exam->Exam_title }}</td>
                    <td class="align-middle examDescription">{{ $exam->description }}</td>
                    <td class="align-middle icon">{{ $exam->coursename }}</td>
                    <td class="align-middle icon">{{ $exam->coursetestname }}</td>
                    <th style="display:none">{{ $exam->courseid }}</th>

                    <th style="display:none">{{ $exam->coursetestid}}</th>
