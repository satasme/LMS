...
<body>
    ...
    <div class="alert alert-danger">
        ...
        <ul>
         ...
         @endif
             ...
             @endphp
              ...
              <input type="hidden" name="examcode" class="form-control" id="hidencoursecode" value="Exm:{{ $newunionid }}">
        ...
        <input type="text" name="Exam_title" class="form-control" id="exampleFormControlInput1" placeholder="Enter the name">
                </div>
                <div class="form-group">
                    <label>Course</label>
    ...
    <table id="modetab" class="table table-bordered">
      ...
      <tbody>
        ...
        <tr class="data-row">
            ...
            <td class="align-middle examIcon"><img  width="75" src="{{  URL::to('/') }}/images/{{ $exam->icon }}" /></td>
