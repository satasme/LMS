...
<body>
    ...
    <div class="page-container">
                    ...
                    <nav>
                        ...
                        <li><a href="{{ url('admin/home') }}"><i class="ti-map-alt"></i> <span>Home</span></a></li>
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    <li><a href="{{ url('admin/home/course-models') }}">Course Models</a></li>
                                    <li><a href="{{ url('admin/home/paper-categories') }}">paper categories</a></li>
                                </ul>
                            </li>
                            <li>
        ...
        <div class="main-content">
            <!-- header area start -->
            <p>This is model for the Course</p>
