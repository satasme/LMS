...
<body>
 ...
 <div class="col-md-6">  
  ...
  <form method="post" action="{{ route('headingoptions.store') }}">
@csrf
@php
$z=1;
$y=1;
...
<div class="">
      <input type="hidden" class="form-control" name="id[]" value="{{ $order->hid }}">

    <div class="form-group">
      <label for="opt[]" class=" text-md-right">option{{$z}}</label>
...
<input type="text" class="form-control" name="questions" value="Enter No of Questions to be added">
