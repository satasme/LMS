...
<body>
    ...
    <div class="page-container">
        ...
        <div class="page-title-area">
            ...
            <div class="col-md-9"><p style="color:white;text-align:center;letter-spacing: 2.5px;">All Course Modes</p></div>
            <div class="col-md-3">
    ...
    <div class="alert alert-danger">
        ...
        <ul>
         ...
         @endif
              <form class="add-form" method="post" action="{{ route('coursemodes.store') }}" enctype='multipart/form-data' >
              @csrf
             ...
             @endphp
              ...
              <input type="hidden" name="modeid" class="form-control" id="hidencoursecode" value="CM:{{ $newunionid }}">
              <div class="form-group">
        <label for="exampleFormControlInput1">Mode Name</label>
        <input type="text" name="mode_title" class="form-control" id="exampleFormControlInput1" placeholder="Enter the name">
                </div>
                <div class="form-group">
...
<div class="details">
    ...
    <table id="modetab" class="table table-bordered">
        ...
        <tr>
            ...
            <th>Mode Code</th>
            <th width="226px">Mode Icon</th>
            <th width="106px">Mode Name</th>
            <th width="202px">modes Description</th>
        ...
        <tr class="data-row">
            <td style="display:none;" class="align-middle modeid">{{ $coursemode->id }}</td>
            <td class="align-middle modeCode">{{ $coursemode->modeid }}</td>
            <td class="align-middle modeIcon"><img  width="75" src="{{  URL::to('/') }}/images/{{ $coursemode->icon }}" /></td>
            <td class="align-middle modetitle">{{ $coursemode->mode_title }}</td>
            <td class="align-middle modeDescription">{{ $coursemode->description }}</td>
           <td  style="display:none"class="align-middle icon">{{ $coursemode->icon }}</td>
            <td class="align-middle" >
                
   
                    <a id="edit-item" class="btn btn-primary edit" >Edit</a>
                    
                   <form style="float:right;" method="post" action="{{ route('coursemodes.destroy',$coursemode->id) }}">
                      @csrf
                      @method('DELETE')
